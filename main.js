...
const nuvem = document.query.Selector(".nuvem")
const startButton = document.query.Selector(".start")
...
const updateScore = () => {
    ...
    pipe.style.animation = `pipe-animation ${animationSpeed}s infinie linear`;
}
